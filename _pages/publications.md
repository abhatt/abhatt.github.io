...
<div class="research-columns">
  ...
  <aside class="research-activities" aria-labelledby="professional-activities-title">
    ...
    <ul>
      ...
      <li><a href="{{ '/causalityrg.html' | relative_url }}">Causality &amp; Algorithms Virtual Reading Group</a></li>
      <li><a href="https://events.csa.iisc.ac.in/LAC15/">Symposium on Learning, Algorithms and Complexity</a></li>
      <li><a href="{{ '/fourier/' | relative_url }}">FOURIER</a></li>
      <li><a href="{{ '/hofa/' | relative_url }}">Higher-Order Fourier Analysis</a></li>
    </ul>
